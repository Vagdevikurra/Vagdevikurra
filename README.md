...
# ══════════════════════════════════════════════════════════════════════════════════
# STEP A: Write raw IP rows (3-way join only, NO window function)
# ══════════════════════════════════════════════════════════════════════════════════
print("\n[STEP A] Raw IP rows ...")
...
""")
print("[OK] Raw rows written")


# ══════════════════════════════════════════════════════════════════════════════════
# STEP B: Build final table = raw + count + address (reads from Hive, light work)
# ══════════════════════════════════════════════════════════════════════════════════
print("\n[STEP B] Final account table ...")
