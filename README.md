...
# =============================================================================
# STEP 1b: LAST LOGIN DATES — from digital_banking_master (all-time dates)
# Transmit only goes back to Aug 2025 — using it for login dates would
# zero out the 90-day window for Aug/Sep/Oct 2025 month-ends.
# digital_banking_master stores the all-time last login per customer.
# =============================================================================
...
print("Max DBM date       : {}".format(max_dbm_dt))
