...
# =============================================================================
# STEP 1: DIGITAL FLAGS  — transmit_digital_logins only
#
# channel = "Online"  =>  OLB
# channel = "Mobile"  =>  Mobile
# Enrolled = has ANY login record for that channel
# Active   = last login within 90 days of max_login_date
# =============================================================================
...
digital_flags = (
    ...
    # Dec uses Dec month-end, Nov uses Nov month-end, etc.
    # Only enrolled flags + last login dates stored here.
